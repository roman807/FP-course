...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def isEmptySet: Boolean = false

  def mostRetweeted: Tweet = {
    if (left.isEmptySet && right.isEmptySet) elem
    else if (right.isEmptySet)
      if (elem.retweets > left.mostRetweeted.retweets) elem
      else left.mostRetweeted
    else if (left.isEmptySet)
    ...
    else if (elem.retweets > left.mostRetweeted.retweets) right.mostRetweeted
    else if (elem.retweets > right.mostRetweeted.retweets) left.mostRetweeted
